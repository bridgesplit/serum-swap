...
class Swap {
    ...
    async swapIxs(params) {
        let { fromMint, toMint, quoteWallet, fromWallet, toWallet, amount, market, minExpectedSwapAmount, referral, } = params;
    ...
    async swapDirectIxs({ coinWallet, pcWallet, baseMint, quoteMint, side, amount, market, minExpectedSwapAmount, referral, }) {
